...
/* Line 250 of yacc.c  */
#line 76 "jsonparser-grammar.c"
/* Substitute the variable and function names.  */
#define yyparse         jsonparser_parse
#define yylex           jsonparser_lex
#define yyerror         jsonparser_error
#define yylval          jsonparser_lval
#define yychar          jsonparser_char
#define yydebug         jsonparser_debug
#define yynerrs         jsonparser_nerrs
#define yylloc          jsonparser_lloc

/* Copy the first part of user declarations.  */


/* Line 268 of yacc.c  */
#line 91 "jsonparser-grammar.c"
...
#define KW_JSON_PARSER 10511
#define KW_PREFIX 10512
#define KW_MARKER 10513
...
/* Line 343 of yacc.c  */
#line 437 "jsonparser-grammar.c"
/* Unqualified %code blocks.  */

/* Line 344 of yacc.c  */
#line 29 "jsonparser-grammar.y"
...
{
     154,     0,    -1,     6,   155,    -1,    -1,   144,   147,   156,
     157,   148,    -1,   158,   157,    -1,    -1,   145,   147,   159,
     148,    -1,   146,   147,   159,   148,    -1,   125,    -1,   128,
      -1
};
...
{
       0,   351,   351,   357,   356,   365,   366,   370,   371,   569,
     570
};
#endif
...
static const char *const yytname[] =
{
  ...
  "KW_JSON_PARSER", "KW_PREFIX", "KW_MARKER", "'('", "')'", "'{'", "'}'",
  "';'", "':'", "$accept", "start", "parser_expr_json", "$@1",
  "parser_json_opts", "parser_json_opt", "string", 0
};
#endif
...
static const yytype_uint16 yytoknum[] =
{
   ...
   10506, 10507, 10508, 10509, 10511, 10512, 10513,    40,    41,   123,
     125,    59,    58
};
# endif
...
{
       0,   153,   154,   156,   155,   157,   157,   158,   158,   159,
     159
};
...
{
      -2,  -139,     6,  -140,  -145,  -145,  -145,  -144,  -138,  -137,
    -136,  -144,  -125,  -125,  -145,  -145,  -145,  -145,  -135,  -134,
    -145,  -145
};
...
{
     125,   145,   146,   128,     6,   144,     0,   147,    11,   147,
     147,    -1,   148,   148,   148,    13
};
...
{
       0,     6,   154,   144,   155,     0,   147,   156,   145,   146,
     157,   158,   147,   147,   148,   157,   125,   128,   159,   159,
     148,   148
};
...
/* Line 1806 of yacc.c  */
#line 370 "jsonparser-grammar.y"
    { log_json_parser_set_prefix(last_parser, (yyvsp[(3) - (4)].cptr)); free((yyvsp[(3) - (4)].cptr)); }
    break;

  case 8:

/* Line 1806 of yacc.c  */
#line 371 "jsonparser-grammar.y"
    { log_json_parser_set_marker(last_parser, (yyvsp[(3) - (4)].cptr)); free((yyvsp[(3) - (4)].cptr)); }
    break;



/* Line 1806 of yacc.c  */
#line 2903 "jsonparser-grammar.c"
      default: break;
    }
